...
void handleClient(int fd, ServerState &state)
{
    ...
    while (true) {
        ...
        else if (cmd == "CALL")          cmdCall(fd, parts, state);
        else if (cmd == "CALL_ACCEPT")   cmdCallAccept(fd, parts, state);
        else if (cmd == "CALL_PORT")     cmdCallPort(fd, parts, state);
        else if (cmd == "CALL_REJECT")   cmdCallReject(fd, parts, state);
        else if (cmd == "CALL_END")      cmdCallEnd(fd, parts, state);
